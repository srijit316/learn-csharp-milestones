...
- [ ] ✏️ Open the reference manual for any component from inside Unity. Paste the link: (https://docs.unity3d.com/6000.2/Documentation/ScriptReference/Transform.html)
